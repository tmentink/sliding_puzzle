...
var Hashtable = function(UNDEFINED) {
  ...
  if (typeof encodeURIComponent == UNDEF || Array.prototype.splice === UNDEFINED || Object.prototype.hasOwnProperty === UNDEFINED) {
    return null;
  }
  function toStr(obj) {
...
var puzzle = function(puzzle) {
  ...
  var setImage = function() {
    $(".puzzle__tile").css({
      backgroundImage: "url(img/" + puzzle.imageID + ".jpg)"
    });
  };
  // Next Image
  // =======================================
...
var puzzle = function(puzzle) {
  ...
  var setGridSize = function(size) {
    if (puzzle.isAnimating || puzzle.gridSize == size) {
      return false;
    }
...
var puzzle = function(puzzle) {
  ...
  var start = function() {
    puzzle.isReady = true;
    $cache(".puzzle").addClass("puzzle--tiled").removeClass("puzzle--change");
    puzzle.utility.getLastTile().addClass("puzzle__tile--hidden");
  };
  // Stop
  // =======================================
  var stop = function() {
    puzzle.isReady = false;
    $cache(".puzzle").removeClass("puzzle--tiled puzzle--change");
    puzzle.utility.getLastTile().removeClass("puzzle__tile--hidden");
  };
  // Change
  // =======================================
  var change = function() {
...
var search = function(search) {
  ...
  var setQueue = function() {
    search.queue = new PriorityQueue({
...
var search = function(search) {
  ...
  Node.prototype = {
    setValue: function() {
      this.value = this.depth + search.heuristic(this.state);
    },
    canMoveUp: function() {
      return this.emptyRow > 0;
    },
    canMoveDown: function() {
      return this.emptyRow < this.size - 1;
    },
    canMoveLeft: function() {
      return this.emptyCol > 0;
    },
    canMoveRight: function() {
      return this.emptyCol < this.size - 1;
    },
    expandUp: function() {
      return search.expandNode(this, "up");
    },
    expandDown: function() {
      return search.expandNode(this, "down");
    },
    expandLeft: function() {
      return search.expandNode(this, "left");
    },
    expandRight: function() {
      return search.expandNode(this, "right");
    }
  };
  // Public Objects
  // =======================================
