...
!function(puzzle) {
  ...
  var mobileInit = function() {
    $cache(".puzzle").removeClass("puzzle--tablet puzzle--desktop").addClass("puzzle--mobile");
    puzzle.config.puzzleSize = puzzle.config.mobileSize;
  };
  // Tablet Init
  // ========================================
  var tabletInit = function() {
    $cache(".puzzle").removeClass("puzzle--mobile puzzle--desktop").addClass("puzzle--tablet");
    puzzle.config.puzzleSize = puzzle.config.tabletSize;
  };
  // Desktop Init
  // ========================================
  var desktopInit = function() {
    $cache(".puzzle").removeClass("puzzle--mobile puzzle--tablet").addClass("puzzle--desktop");
